...
extension DateComponents {
    ...
    init(glucoseEventBytes: Data) {
        ...
        year   = Int(glucoseEventBytes[0] & 0b01111111) + 2000
        month = Int((glucoseEventBytes[3] & 0b11000000) >> 4 +
                    (glucoseEventBytes[2] & 0b11000000) >> 6)
        day    = Int(glucoseEventBytes[1] & 0b00011111)
        hour   = Int(glucoseEventBytes[3] & 0b00011111)
        minute = Int(glucoseEventBytes[2] & 0b00111111)
